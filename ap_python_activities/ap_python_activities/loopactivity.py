...
if the_code = 33
 print(33 < prize)
else  the code isnt 33
print(1 < no prize)

# 3. describe the difference between a while loop and a conditional statement. 
# Try be as specific as you can
A while loop will run as many times as it needs to while a condition is true, i.e., 
until that condition is false. An if statement will execute once if a condition is true.

# 4. Create a while loop that will iterate over the list of names 
# and print out only the following name: William


list of names ['Avery','Paige','William','Ade','Jasmyn','likk']

index = 1
names = ['Avery', 'William', 'ade' , 'Paige' , 'Jasmyn' , 'Crystal']
