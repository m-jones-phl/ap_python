...
#paramaters are the place holder in our functions definition
...
# a tool in python that allow programs tocontroll the flow of program depending on the senario
...
# a boolean. 
  ...
  a = food in the fridge
b = no food in the fridge
if b > a:
...
check inventory
more than 10 boxes = full
less than 10 boxes = "we need to order more cereal"
if more than 10 boxes a:
  print("b is greater than a")